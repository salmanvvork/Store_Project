 ...
 $.fn.tweets = function( options ){
  ...
  var settings = {
   ...
   wow_themes.tweets( options, this );
	...
	//for custom Nav
	jQuery('#testiController > .fa-angle-left').click(function(){
		jQuery('#testiSlider').slick('slickPrev');
	});
	jQuery('#testiController > .fa-angle-right').click(function(){
		jQuery('#testiSlider').slick('slickNext');
	});
